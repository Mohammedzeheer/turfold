...
function VenueManager() {
  ...
  useEffect(() => {
    axios.get('http://localhost:4000/admin/manager', { withCredentials: true })
      .then((res) => {
        console.log(res, '------------------------------------------');
  ...
  const blockUser = (userId) => {
    axios.post(`http://localhost:4000/admin/blockuser`, { userId }, { withCredentials: true })
      .then((res) => {
        console.log(res, 'fdsfsddhsfdfsdffd');
        // You can update the state or perform any other necessary actions after blocking/unblocking the user
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  const UnblockUser =(userId)=>{
    axios.post(`http://localhost:4000/admin/unblockuser`, { userId }, { withCredentials: true })
    .then((res) => {
      console.log(res, 'fdsfsddhsfdfsdffd');
    })
    .catch((error) => {
